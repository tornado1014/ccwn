...
```powershell
irm https://raw.githubusercontent.com/YOUR_USERNAME/claude-code-windows-notify/main/install.ps1 | iex
```
...
1. Clone the repository:
   ```powershell
   git clone https://github.com/YOUR_USERNAME/claude-code-windows-notify.git
